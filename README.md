...
<script>
    ...
    function saveMatch() {
        ...
        if(editId !== "") {
            ...
            // Deduct 1 match from user's active 3-match subscription if applicable
            let currentPhone = localStorage.getItem('current_user');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('verifyOtpBtn').addEventListener('click0', verifyOTP); // handled inside verifyOTP
